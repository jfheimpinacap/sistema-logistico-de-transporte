...
export function IncidentsPage() {
  ...
  const exportFilters = useMemo(() => ({ category, severity, status, is_active: activeFilter }), [activeFilter, category, severity, status])
