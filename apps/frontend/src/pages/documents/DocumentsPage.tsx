...
export function DocumentsPage() {
  ...
  const exportFilters = useMemo(() => ({ document_type: documentType, status, is_active: activeFilter }), [activeFilter, documentType, status])
